...
export function BucketCard({ bucket, startingBalance, selectable, selected, onClick, justUpdated }: Props) {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        selectable && "cursor-pointer hover:-translate-y-0.5 hover:shadow-[0_2px_4px_oklch(0.22_0.02_160/0.06),0_16px_40px_oklch(0.22_0.02_160/0.08)] active:scale-[0.99]",
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            <h3 className="text-sm font-medium text-muted-foreground tracking-wide">{bucket.name}</h3>
            {isChild && (
